...
<head>
    ...
    <title>Ulasan Terendah | Mickey Mauze Shop</title>
    <style>
        ::-webkit-scrollbar {
            display: none;
        }
...
<body>
    ...
    <div class="container">
        ...
        <?php
        $query = "SELECT produk.id_produk, produk.pic, produk.nama, pembeli, ulasan, rating, beli FROM pembelian JOIN produk ON pembelian.id_produk = produk.id_produk ORDER BY rating ASC";
